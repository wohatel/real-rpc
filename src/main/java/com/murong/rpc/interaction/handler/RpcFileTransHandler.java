...
public interface RpcFileTransHandler {
     ...
     */
    default void onProcess(final File file, final RpcFileTransModel remoteTransModel, final JSONObject context, final RpcFileTransProcess rpcFileTransProcess) {
     ...
     * errorMsg 错误信息
     */
    void onSuccess(final File file, final RpcFileTransModel remoteTransModel, final JSONObject context);
